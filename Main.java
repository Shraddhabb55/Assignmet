 ...
 class TeamStats
 {
     ...
     public void consecutiveWinOrLose(ArrayList <TeamStats> teamsStats , String userInputOfWinOrLose , int n)
     {
         ...
         this.listOfTeamsWithConsecutiveWinOrLose();
         teamsWithConsecutiveWinOrLose.clear();
     }
 
     public void twoConsecutiveWinOrLose(ArrayList <TeamStats> teamsStats){
         System.out.println("-----------------------------------------------------");
         System.out.println("Teams with two consecutive losses are :");
         consecutiveWinOrLose(teamsStats,"L",2);
         System.out.println("-----------------------------------------------------");
 ...
 public class Main
 {
     public static void main(String[] args)
     {
         ...
         stats.twoConsecutiveWinOrLose(teamsStats);
